...
var ULTRAVOX_SDK_VERSION = "0.5.0";

// node_modules/ultravox-client/dist/esm/index.js
var UltravoxSessionStatus;
(function(UltravoxSessionStatus2) {
  UltravoxSessionStatus2["DISCONNECTED"] = "disconnected";
  UltravoxSessionStatus2["DISCONNECTING"] = "disconnecting";
  UltravoxSessionStatus2["CONNECTING"] = "connecting";
  UltravoxSessionStatus2["IDLE"] = "idle";
  UltravoxSessionStatus2["LISTENING"] = "listening";
  UltravoxSessionStatus2["THINKING"] = "thinking";
  UltravoxSessionStatus2["SPEAKING"] = "speaking";
...
var AgentReaction;
(function(AgentReaction2) {
  AgentReaction2["SPEAKS"] = "speaks";
  AgentReaction2["LISTENS"] = "listens";
  AgentReaction2["SPEAKS_ONCE"] = "speaks-once";
})(AgentReaction || (AgentReaction = {}));
var Transcript = class {
  constructor(text, isFinal, speaker, medium, ordinal) {
    __publicField(this, "text");
    __publicField(this, "isFinal");
    __publicField(this, "speaker");
    __publicField(this, "medium");
...
var UltravoxSessionStatusChangedEvent = class extends Event {
  constructor() {
    super("status");
  }
};
var UltravoxTranscriptsChangedEvent = class extends Event {
  constructor() {
    super("transcripts");
  }
};
var UltravoxDataMessageEvent = class extends Event {
  constructor(message) {
...
var UltravoxVideoTrackSubscribedEvent = class extends Event {
...
var _UltravoxSession = class _UltravoxSession extends EventTarget {
  /**
   ...
   */
  constructor({ audioContext, additionalMessages, videoElement } = {}) {
    super();
    __publicField(this, "_transcripts", []);
    __publicField(this, "_status", UltravoxSessionStatus.DISCONNECTED);
    __publicField(this, "registeredTools", /* @__PURE__ */ new Map());
    __publicField(this, "socket");
    __publicField(this, "room");
    __publicField(this, "videoElement");
    __publicField(this, "audioElement", new Audio());
    __publicField(this, "localAudioTrack");
    __publicField(this, "micSourceNode");
    ...
    __publicField(this, "_isMicMuted", false);
    __publicField(this, "_isSpeakerMuted", false);
    this.audioContext = audioContext || new AudioContext();
    this.additionalMessages = additionalMessages || /* @__PURE__ */ new Set();
    this.videoElement = videoElement;
  }
  ...
  setOutputMedium(medium) {
    if (!_UltravoxSession.CONNECTED_STATUSES.has(this._status)) {
  ...
  async handleSocketMessage(event) {
    ...
    this.room.on(RoomEvent.TrackSubscribed, (track2) => this.handleTrackSubscribed(track2));
    this.room.on(RoomEvent.DataReceived, (payload, participant) => this.handleDataReceived(payload, participant));
    this.audioContext.resume();
    this.audioElement.play();
    const [track, _2] = await Promise.all([createLocalAudioTrack(), this.room.connect(msg.roomUrl, msg.token)]);
    ...
    if (runDefault) {
      if (msg.type === "state") {
        ...
        if (msg.text) {
          ...
          this.addOrUpdateTranscript(ordinal, medium, role, isFinal, void 0, msg.delta);
        }
  ...
  invokeClientTool(toolName, invocationId, parameters) {
    ...
    try {
      ...
      if (result instanceof Promise) {
        result.then((result2) => this.handleClientToolResult(invocationId, result2)).catch((error) => this.handleClientToolFailure(invocationId, error));
      } else {
        this.handleClientToolResult(invocationId, result);
      }
    } catch (e2) {
      this.handleClientToolFailure(invocationId, e2);
    }
  }
...
__publicField(_UltravoxSession, "CONNECTED_STATUSES", /* @__PURE__ */ new Set([
  UltravoxSessionStatus.LISTENING,
  UltravoxSessionStatus.THINKING,
  UltravoxSessionStatus.SPEAKING
]));
var UltravoxSession = _UltravoxSession;
export {
  UltravoxSession
};
